        ...
        <div class="container">
            ...
            <div class="module span9 offset0">
                <form class="form-vertical" action="index.php?controller=skin/edit&act=edit&id=<?php echo $value["SpID"] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="module-option clearfix">
                            <div class="media-body">
                                ...
                                <center>
                                    ...
                                    <a href="index.php?controller=skin/list" class="btn btn-info" style="margin-top: 10px;">Back</a>
                                </center>
                            </div>
                        </div>
                    </form>
