    ...
    <div class="content">
        <div class="module">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered display" width="100%">
                ...
                <form action="index.php?controller=skin/search&act=search" method="post" enctype="multipart/form-data">
                    ...
                    <form>
                        ...
                        <a href="index.php?controller=skin/add" class="btn btn-success" type="submit">Add +</a>
                            <br>
                            <br>
                    ...
                    <tbody>
                        ...
                        <td>
                        <a href="index.php?controller=skin/edit&id=<?php echo $row["SpID"] ?>">View</a>                                          
                            <br>
                        <a href="index.php?controller=skin/list&act=delete&id=<?php echo $row['SpID'] ?>">Delete</a>
                        </td>
                        </tr>
                    </tbody>
                <?php } ?>
...
<div class="pull-right">        
	<?php for($i=1; $i<=$page_show; $i++){ ?>
		<li><a href="index.php?controller=skin/list&p=<?php echo $i ?>"><?php echo $i; ?></a></li>
	<?php } ?>
</div>
</ul>
</div>
