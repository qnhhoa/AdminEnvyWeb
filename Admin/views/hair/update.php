<div class="wrapper">
        <div class="container">
            <div class="row">
                ...
                <form class="form-vertical" action="index.php?controller=hair/edit&act=edit&id=<?php echo $value["SpID"] ?>" method="post" enctype="multipart/form-data">
                        <div class="module-head">
                            <h3>Add HairCare Product</h3>
                        </div>
                        <div class="module-option clearfix">
                            <div class="media-body">
                                ...
                                <center>
                                    ...
                                    <a href="index.php?controller=hair/list" class="btn btn-info" style="margin-top: 10px;">Back</a>
                                </center>
                            </div>
                        </div>
                    </form>
