    ...
    <div class="content">
        <div class="module">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered display" width="100%">
                ...
                <form action="index.php?controller=hair/search&act=search" method="post" enctype="multipart/form-data">
                    ...
                    <form>
                        ...
                        <a href="index.php?controller=hair/add" class="btn btn-success" type="submit">Add +</a>
                            <br>
                            <br>
                    ...
                    <tbody>
                        ...
                        <td>
                        <a href="index.php?controller=hair/edit&id=<?php echo $row["SpID"] ?>">View</a>                                          
                            <br>
                        <a href="index.php?controller=hair/list&act=delete&id=<?php echo $row['SpID'] ?>">Delete</a>
                        </td>
                        </tr>
                    </tbody>
                <?php } ?>
...
<div class="pull-right">        
	<?php for($i=1; $i<=$page_show; $i++){ ?>
		<li><a href="index.php?controller=hair/list&p=<?php echo $i ?>"><?php echo $i; ?></a></li>
	<?php } ?>
</div>
</ul>
</div>
