...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2021 at 06:37 PM
...
('104353224208067050500', '', 'Hoa Phan Phạm Quỳnh', '', '', 1, '19521520@gm.uit.edu.vn', 'https://lh3.googleusercontent.com/a/AATXAJxPd93JQyW0mePBy3sCCtgvHEzLmuoYz94Xdr-q=s96-c'),
('112604892139527679327', '', 'Huỳnh Tân', '', '', 1, 'hihitanne@gmail.com', 'https://lh3.googleusercontent.com/a-/AOh14GjMZArVE4xVTtaJbc5UY_-BpZP9d6gMdBi9m93fnw=s96-c'),
...
('anhtuyetmai1212', '1212', '12dasdsd', '2147483647', 'SG', 1, 'vbjk22@gmail.com', ''),
...
('qnhhoa', '123', 'Phan Phạm Quỳnh Hoa', '0363882', 'TPHCM', 0, 'quynhhoa090801@gmail.com', ''),
...
(9, 'Delivered', '2021-12-18 14:34:26', '2021-12-23'),
...
(79, 'Pickup', '2021-12-27 00:27:37', '2021-12-30');
...
(9, 'lenhan', 'SG', '06748', 'Le Anh Nhan', '', 40, 'Momo Wallet'),
...
(79, 'qnhhoa', 'HN', '07288', 'Phan Phạm Quỳnh Hoa', '', 70, 'cash');
...
(39, 'BLONDE PERFECTING PURPLE SHAMPOO', '{\"PhotoMain\":\"https://i.upimg.com/x3jqUdNBC\",\"PhotoList\":[{\"photo\":\"https://i.upimg.com/yuaNffuJe\"},{\"photo\":\"https://i.upimg.com/Dr70h1QdQ_\"},{\"photo\":\"https://i.upimg.com/9423_Pgeu\"}]}', 'Fight brassiness in blonde, lightened brunette, and grey hair with this sulfate-free purple shampoo. Featuring deep violet pigments to counteract unwanted yellow and orange tones, this professional-strength tone-correcting shampoo helps you maintain your ideal haircolor between salon appointments. The gentle formula cleanses without drying and contains ArganID™ to help repair hair from the inside out. Color-safe. Sulfate, phosphate, and paraben-free. ', 3, 24, 100, 14),
...
--
ALTER TABLE `hoadon`
  MODIFY `MaHD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `sanpham`
  MODIFY `SpID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
ALTER TABLE `cthd`
  ...
  ADD CONSTRAINT `fk_cthd_sp` FOREIGN KEY (`SpID`) REFERENCES `sanpham` (`SpID`) ON DELETE NO ACTION ON UPDATE CASCADE;
